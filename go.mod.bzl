...
def go_repositories():
    ...
    go_repository(
        ...
        sum = "h1:uUhdsDMg2GbFLF5GfQPtLMWd5vdDZSfqvqQp3waafxQ=",
        version = "v0.9.3-0.20191028180845-3492b2aff503",
    )
    go_repository(
    ...
    go_repository(
        ...
        sum = "h1:AFZdJUT7jJYXQEC29hYH/WZkoV7+KhwxQGmdZ19yYoY=",
        version = "v0.0.0-20200403190813-44a64ad78b9b",
    )
    go_repository(
