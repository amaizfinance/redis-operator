...
func GetOpenAPIDefinitions(ref common.ReferenceCallback) map[string]common.OpenAPIDefinition {
	return map[string]common.OpenAPIDefinition{
		"./api/v1alpha1.ContainerSpec": schema_pkg_apis_k8s_v1alpha1_ContainerSpec(ref),
		"./api/v1alpha1.Password":      schema_pkg_apis_k8s_v1alpha1_Password(ref),
		"./api/v1alpha1.Redis":         schema_pkg_apis_k8s_v1alpha1_Redis(ref),
		"./api/v1alpha1.RedisList":     schema_pkg_apis_k8s_v1alpha1_RedisList(ref),
		"./api/v1alpha1.RedisSpec":     schema_pkg_apis_k8s_v1alpha1_RedisSpec(ref),
		"./api/v1alpha1.RedisStatus":   schema_pkg_apis_k8s_v1alpha1_RedisStatus(ref),
	}
}
...
func schema_pkg_apis_k8s_v1alpha1_Redis(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
		Schema: spec.Schema{
			SchemaProps: spec.SchemaProps{
				...
				Properties: map[string]spec.Schema{
					...
					"spec": {
						SchemaProps: spec.SchemaProps{
							Ref: ref("./api/v1alpha1.RedisSpec"),
						},
					},
					"status": {
						SchemaProps: spec.SchemaProps{
							Ref: ref("./api/v1alpha1.RedisStatus"),
						},
					},
				},
		...
		Dependencies: []string{
			"./api/v1alpha1.RedisSpec", "./api/v1alpha1.RedisStatus", "k8s.io/apimachinery/pkg/apis/meta/v1.ObjectMeta"},
	}
}
...
func schema_pkg_apis_k8s_v1alpha1_RedisSpec(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
				...
				Properties: map[string]spec.Schema{
					...
					"redis": {
						SchemaProps: spec.SchemaProps{
							...
							Ref:         ref("./api/v1alpha1.ContainerSpec"),
						},
					},
					"exporter": {
						SchemaProps: spec.SchemaProps{
		...
		Dependencies: []string{
			"./api/v1alpha1.ContainerSpec", "./api/v1alpha1.Password", "k8s.io/api/core/v1.Affinity", "k8s.io/api/core/v1.Container", "k8s.io/api/core/v1.LocalObjectReference", "k8s.io/api/core/v1.PersistentVolumeClaim", "k8s.io/api/core/v1.PodSecurityContext", "k8s.io/api/core/v1.Toleration", "k8s.io/api/core/v1.Volume"},
	}
}
